...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _files_libs_datePicker_air_datepicker_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../files/libs/datePicker/air-datepicker.js */ \"./src/files/libs/datePicker/air-datepicker.js\");\n/* harmony import */ var _files_libs_datePicker_index_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../files/libs/datePicker/index.es.js */ \"./src/files/libs/datePicker/index.es.js\");\n/* harmony import */ var _modules_script_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/script.js */ \"./src/js/modules/script.js\");\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n\n\n\n\n\n\n\n\n/* Модуль для работы с меню (Бургер) */\n\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_3__.menuInit();\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_3__.tabs();\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_3__.accordion();\n\n\nif(document.querySelector('#account')) {\n    //выпадашка с поиском товара\n    let getProduct = document.querySelector('[data-catalog]')\n        let catalog = document.querySelector('.catalog')\n        // getProduct.addEventListener(\"click\", function (e) {\n        //     catalog.classList.add('open')\n        // });\n         // скрываем все по клику вне объекта\n    document.addEventListener('click', (e) => {\n        if (e.composedPath().includes(getProduct)) {\n            catalog.classList.add('open')\n        } else if (!e.composedPath().includes(catalog)) {\n            catalog.classList.remove('open')\n        }\n      });\n}\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scripts_dynamicAdapt_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/dynamicAdapt.js */ \"./src/js/modules/scripts/dynamicAdapt.js\");\n/* harmony import */ var _scripts_ibg_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/ibg.js */ \"./src/js/modules/scripts/ibg.js\");\n/* harmony import */ var _scripts_popup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/popup.js */ \"./src/js/modules/scripts/popup.js\");\n/* harmony import */ var _scripts_maskTel_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/maskTel.js */ \"./src/js/modules/scripts/maskTel.js\");\n/* harmony import */ var _scripts_swiper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/swiper.js */ \"./src/js/modules/scripts/swiper.js\");\n/* harmony import */ var _scripts_form_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/form.js */ \"./src/js/modules/scripts/form.js\");\n/* harmony import */ var _scripts_airDatapicker_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scripts/airDatapicker.js */ \"./src/js/modules/scripts/airDatapicker.js\");\n/* harmony import */ var _files_libs_accordion_accordion_min_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../files/libs/accordion/accordion.min.js */ \"./src/files/libs/accordion/accordion.min.js\");\n\n\n\n\n\n\n\n\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/script.js?");

/***/ }),

/***/ "./src/js/modules/scripts/airDatapicker.js":
/*!*************************************************!*\
  !*** ./src/js/modules/scripts/airDatapicker.js ***!
  \*************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _files_libs_datePicker_air_datepicker_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../files/libs/datePicker/air-datepicker.js */ \"./src/files/libs/datePicker/air-datepicker.js\");\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_files_libs_datePicker_air_datepicker_js__WEBPACK_IMPORTED_MODULE_0__);\n\nfunction datesInit() {\n  //на след. день\n  // var minDate = new Date();\n  // minDate.setDate(minDate.getDate() + 1);\n  const inputDates = Array.from(document.querySelectorAll(\".input-date\"));\n  const mediaQuery = window.matchMedia(\"(min-width: 768px)\");\n\n  inputDates.forEach((date, i) => {\n    date.setAttribute(\"id\", `datepicker${i}`);\n    let dates = []; // Масив с календарями\n    const dateID = date.getAttribute(\"id\");\n    console.log(date);\n    console.log(date.disabled);\n    if (!date.disabled) {\n      if (mediaQuery.matches) {\n        dates[i] = new _files_libs_datePicker_air_datepicker_js__WEBPACK_IMPORTED_MODULE_0__(\"#\" + `${dateID}`, {\n          autoClose: true,\n          //на след. день\n          // minDate: minDate,\n          // selectedDates: minDate,\n          minDate: new Date(),\n          selectedDates: new Date(),\n          dateFormat: 'dd.MM.yy',\n        });\n      } else {\n        dates[i] = new _files_libs_datePicker_air_datepicker_js__WEBPACK_IMPORTED_MODULE_0__(\"#\" + `${date}`, {\n          isMobile: true,\n          autoClose: true,\n          minDate: new Date(),\n          selectedDates: new Date(),\n          dateFormat(date) {\n            return date.toLocaleString('ja', {\n                year: 'numeric',\n                day: '2-digit',\n                month: 'yy'\n            });\n        }\n        });\n      }\n    }\n  });\n}\ndatesInit();\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/scripts/airDatapicker.js?");
...
/***/ "./src/js/modules/scripts/form.js":
/*!****************************************!*\
  !*** ./src/js/modules/scripts/form.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n//ограничиваем ввод чисел на форме \"количества товара\"\nconst inputs = document.querySelectorAll('.item__column-countinput[type=number]');\nArray.from(inputs).forEach(input => {\n    const min = +input.min;\n    const max = +input.max;\n\n    input.addEventListener('input', (e) => {\n        const value = +input.value;\n        if (value > max) { input.value = max }\n        else if (value < min) { input.value = min }\n    })\n});\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/scripts/form.js?");
...
/***/ "./src/js/modules/scripts/maskTel.js":
/*!*******************************************!*\
  !*** ./src/js/modules/scripts/maskTel.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! imask */ \"./node_modules/imask/esm/index.js\");\n\n//маска для телефона\n// сниппер masktel\nlet phoneInput = document.querySelectorAll('[data-mask-tel]');\nfor (let i = 0; i < phoneInput.length; i++) {\n  let elem = phoneInput[i]\n  const phoneMask = new imask__WEBPACK_IMPORTED_MODULE_0__[\"default\"](phoneInput[i], {\n    mask: \"+{7}(000)000-00-00\",\n    prepare: function (appended, masked) {\n      if (appended === '8' && masked.value === '') {\n        return '';\n      }\n      return appended;\n    },\n  });\n\n  // появление галочки когда маска полностью закончена\n  elem.addEventListener(\"input\", function (event) {\n     if(elem.closest('.request')) { // имя раздела в котором находится инпут\n       if(phoneMask.masked.isComplete) {\n         elem.parentNode.querySelector('span').style.display = \"block\"\n       } else {\n         elem.parentNode.querySelector('span').style.display = \"none\"\n   \n       }       \n      }\n  });\n}\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/scripts/maskTel.js?");
